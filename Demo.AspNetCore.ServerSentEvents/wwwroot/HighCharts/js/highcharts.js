...
(function (S, M) {
	...
	(function (a) {
			...
			initPath: function (p, f, l) {
				...
				function w(a, k) {
					for (var e = (c - a.length) / d; 0 < e && e--; )
						b = a.slice().splice(a.length / B - d, d * B), b[0] =
		...
		a.getStyle = function (p, f, l) {
			...
			if (p = H.getComputedStyle(p, void 0))
				p = p.getPropertyValue(f), a.pick(l, "opacity" !== f) && (p = a.pInt(p));
			return p
		};
		...
		a.fireEvent = function (p, f, l, r) {
			...
			if (D.createEvent && (p.dispatchEvent || p.fireEvent))
				n = D.createEvent("Events"), n.initEvent(f, !0, !0), a.extend(n, l), p.dispatchEvent ? p.dispatchEvent(n) : p.fireEvent(f, n);
			else if (n)
		...
		H.jQuery && (H.jQuery.fn.highcharts =
			...
			if (this[0])
				return p[0] ? (new(a[a.isString(p[0]) ? p.shift() : "Chart"])(this[0], p[0], p[1]), this) : E[a.attr(this[0], "data-highcharts-chart")]
		})
	})(M);
	(function (a) {
		var E = a.each,
	...
	(function (a) {
		...
		c(E.prototype, {
			...
			align: function (a, g, v) {
				...
				O;
				if (a) {
					if (this.alignOptions = a, this.alignByTranslate = g, !v || C(v))
						this.alignTo = y = v || "renderer", b(k, this), k.push(this), v = null
				} else
			...
			shadow: function (a, g, b) {
				...
				if (!a)
					...
					for (v = 1; v <= q; v++)
						c = k.cloneNode(0), d = 2 * q + 1 - 2 * v, f(c, {
							isShadow: "true",
	...
	var V = function (a) {
		...
		a.extend(G.prototype, {
			...
			getSeriesExtremes: function () {
				...
				e(a.series, function (g) {
					if (g.visible || !v.options.chart.ignoreHiddenSeries) {
						...
						if (a.isXAxis)
							c = g.xData, c.length && (g = p(c), k = H(c), B(g) || g instanceof Date || (c = b(c, B),
									g = p(c)), a.dataMin = Math.min(C(a.dataMin, c[0], g), g), a.dataMax = Math.max(C(a.dataMax, c[0], k), k));
						else if (g.getExtremes(), k = g.dataMax, g = g.dataMin, n(g) && n(k) && (a.dataMin = Math.min(C(a.dataMin, g), g), a.dataMax = Math.max(C(a.dataMax, k), k)), n(d) && (a.threshold = d), !c.softThreshold || a.positiveValuesOnly)
							a.softThreshold = !1
					}
				})
			},
			...
			setAxisTranslation: function (a) {
				...
				A = g.isXAxis;
				if (A || m || c)
					d = g.getClosest(), h ? (k = h.minPointOffset, q = h.pointRangePadding) : e(g.series, function (a) {
			...
			zoom: function (a, b) {
				...
				if (a !== this.min || b !== this.max)
					this.allowZoomOutside || (n(g) && (a < k && (a = k), a > d && (a = d)), n(c) && (b < k && (b = k), b > d && (b = d))), this.displayBtn = void 0 !== a || void 0 !== b, this.setExtremes(a, b, !1, void 0, {
						trigger: "zoom"
					});
				return !0
			},
			...
			renderTick: function (a, b) {
				...
				if (!c || a >= this.min && a <= this.max)
					g[a] || (g[a] = new F(this, a)), d && g[a].isNew && g[a].render(b, !0, .1), g[a].render(b)
			},
			render: function () {
				var b =
					this,
		...
		a.Pointer.prototype = {
			...
			findNearestKDPoint: function (a, c, d) {
				...
				r(a, function (a) {
					...
					a = a.searchPoint(d, k);
					if ((k = e(a, !0)) && !(k = !e(b, !0)))
						var k = b.distX - a.distX, h = b.dist - a.dist, m = (a.series.group && a.series.group.zIndex) - (b.series.group && b.series.group.zIndex), k = 0 < (0 !== k && c ? k : 0 !== h ? h : 0 !== m ? m : b.series.index > a.series.index ? -1 : 1);
					k && (b = a)
				});
				return b
			},
			...
			reset: function (a, c) {
				...
				if (a)
					m && f && (m.refresh(f), e && (e.setState(e.state, !0), r(b.axes, function (a) {
		...
		a.Point.prototype = {
			...
			destroyElements: function () {
				for (var a = ["graphic", "dataLabel",
						"dataLabelUpper", "connector", "shadowGroup"], h, f = 6; f--; )
	...
	(function (a) {
		...
		a.Series = a.seriesType("line", null, {
				...
				generatePoints: function () {
					...
					if (c && (h !== (d = c.length) || l))
						for (n = 0; n < d; n++)
							n !== f || l || (n += h), c[n] && (c[n].destroyElements(), c[n].plotX = void 0);
					this.data = c;
					this.points = x
				},
		...
		u.prototype.modifyStacks = function () {
			...
			a[b + "Stacker"] && l([h, "-" + h], function (e) {
				for (var k = d.length, h, l; k--; )
					if (h = d[k], c = a.getStackIndicator(c, h, a.index, e), l = (h = f[e] && f[e][h]) && h.points[c.key])
						a[b + "Stacker"](l, h, k)
			})
		};
		...
		l("area", "line", {
			...
			getGraphPath: function (a) {
				...
				for (h = 0; h < a.length; h++)
					if (m = a[h].isNull, k = p(a[h].rectPlotX, a[h].plotX), x = p(a[h].yBottom, I), !m || r)
						r || K(h, h - 1, "left"), m && !u && r || (c.push(a[h]), d.push({
								x: h,
								plotX: k,
								plotY: x
							})), r || K(h, h + 1, "right");
	...
	(function (a) {
		...
		h("pie", "line", {
			...
			updateTotals: function () {
				...
				this.total = c;
				for (a = 0; a < e; a++)
					f = b[a], f.percentage = 0 < c && (f.visible || !h) ? f.y / c * 100 : 0, f.total = c
			},
			generatePoints: function () {
	...
	(function (a) {
		...
		a.distribute = function (a, b) {
			...
			for (a = r(a, function (a) {
				...
				for (e = a.length; e--; )
					f = a[e], m = (Math.min.apply(0, f.targets) + Math.max.apply(0, f.targets)) / 2, f.pos = Math.min(Math.max(0, m - f.size *
								f.align), b - f.size);
				e = a.length;
				for (f = !1; e--; )
					0 < e && a[e - 1].pos + a[e - 1].size > a[e].pos && (a[e - 1].size += a[e].size, a[e - 1].targets = a[e - 1].targets.concat(a[e].targets), a[e - 1].align = .5, a[e - 1].pos + a[e - 1].size > b && (a[e - 1].pos = b - a[e - 1].size), a.splice(e, 1), f = !0)
			}
			e = 0;
			p(a, function (a) {
				var b = 0;
		...
		h.prototype.drawDataLabels = function () {
			...
			if (e.enabled || b._hasPointLabels)
				b.dlProcessOptions && b.dlProcessOptions(e), w = b.plotGroup("dataLabelsGroup", "data-labels", D && !r ? "hidden" : "visible", e.zIndex || 6), D && (w.attr({
						opacity: +r
			...
			c.visible && (f.enabled || c._hasPointLabels) && (p(b, function (a) {
				...
				m && p(this.points, function (a) {
					...
					if ((F = a.dataLabel) && F._pos && a.visible && 0 < a.labelDistance) {
						...
						if (b = !r)
							a.connector = r = e.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + a.colorIndex).add(c.dataLabelsGroup), r.attr({
								"stroke-width": m,
	...
	(function (a) {
		...
		E.prototype.hideOverlappingLabels = function (a) {
			...
			for (n = 0; n < f; n++)
				if (p = a[n])
					p.oldOpacity = p.opacity, p.newOpacity = 1, p.width || (w = p.getBBox(), p.width = w.width, p.height = w.height);
			a.sort(function (a, b) {
			...
			for (n = 0; n < f; n++)
				for (w = a[n], p = n + 1; p < f; ++p)
					if (u = a[p], w && u && w !== u && w.placed && u.placed && 0 !== w.newOpacity && 0 !== u.newOpacity && (e = w.alignAttr, h = u.alignAttr, m = w.parentGroup, d = u.parentGroup, c = 2 * (w.box ? 0 : w.padding || 0), e = b(e.x + m.translateX, e.y + m.translateY, w.width - c, w.height -
									c, h.x + d.translateX, h.y + d.translateY, u.width - c, u.height - c)))
					...
					if (this.graphic)
						...
						if (a && p) {
							...
							if (r)
								...
								k && (f.stateMarkerGraphic = r = w.renderer.symbol(k, z.x, z.y, z.width, z.height).add(f.markerGroup), r.currentSymbol = k);
			...
			function n(e, h, l, d) {
				...
				a.objectEach(e, function (a, e) {
					if (!d && -1 < H(e, ["series", "xAxis", "yAxis"]))
						...
						f(a) ? (l[e] = p(a) ? [] : {}, n(a, h[e] || {}, l[e], d + 1)) : l[e] = h[e] ||
							null
				})
			}
			var u = {};
